...
public enum Protocols
{
    ...
    PlayerBetting,//배팅(서버가 유저에게 배팅을 보내면 그 유저가 배팅한다 - 순서대로)  1013
    PlayerFold,//폴드
    PlayerCall,//콜
